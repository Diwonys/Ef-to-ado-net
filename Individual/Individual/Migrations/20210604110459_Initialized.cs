        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Borrowers_Banks_BankId",
                        column: x => x.BankId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditTypes_Banks_BankId",
                        column: x => x.BankId,
                        principalTable: "Banks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Guarantors_Borrowers_BorrowerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Borrowers_BankId",
                table: "Borrowers",
                column: "BankId");

            migrationBuilder.CreateIndex(
                name: "IX_CreditTypes_BankId",
                table: "CreditTypes",
                column: "BankId");

            migrationBuilder.CreateIndex(
                name: "IX_Guarantors_BorrowerId",
                table: "Guarantors",
                column: "BorrowerId");
        }
